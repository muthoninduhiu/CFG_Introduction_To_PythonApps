...
def recipe_search(search_term, health_restriction, meal_type):
    ...
    url = requests.get('https://api.edamam.com/search?q={}&app_id={}&app_key={}&mealType={}&health={}'
                       .format(search_term, APP_ID, APP_KEY,health_restriction,meal_type))
